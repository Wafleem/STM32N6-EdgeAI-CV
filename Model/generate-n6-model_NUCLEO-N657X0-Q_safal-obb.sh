...
stedgeai generate --model "${MODEL_PATH}" --target stm32n6 --st-neural-art default@user_neuralart_NUCLEO-N657X0-Q.json --input-data-type uint8 --output-data-type int8
